...
def _append_graphvid_args(cmd: list[str], args: argparse.Namespace) -> None:
    cmd.extend(
        [
            ...
            "--graph_adaptive_detail_protection",
            _str_bool(args.graph_adaptive_detail_protection),
            ...
            "--graph_respect_temporal_threshold",
            _str_bool(args.graph_respect_temporal_threshold),
...
def _append_graftvid_args(cmd: list[str], args: argparse.Namespace) -> None:
    ...
    cmd.extend(
        [
            ...
            "--graft_mutual_knn",
            _str_bool(args.graft_mutual_knn),
            "--graft_one_token_per_frame",
            _str_bool(args.graft_one_token_per_frame),
