...
def _parse_method_list(text: str) -> list[str]:
    ...
    allowed = {
        "graphvid", "flashvid", "talon", "apexvid", "certvid", "certvid_v2", "certvid_v3", "certvid_v6", "certvid_hr", "certvid_sb", "certvid_v4", "certvid_v5", "certvid_e", "faithvid", "prismvid",
...
def _phase_name(method: str) -> str:
    if method in ("talon", "apexvid", "certvid", "certvid_v2", "certvid_v3", "certvid_v6", "certvid_hr", "certvid_sb", "certvid_v4", "certvid_v5", "certvid_e", "faithvid", "prismvid"):
        return "ours"
    return method
...
def main() -> None:
    ...
    parser.add_argument(
        "--methods",
        default="graphvid",
        help="Comma list: graphvid,flashvid,talon,apexvid,certvid,certvid_v2,certvid_v3,certvid_v6,certvid_hr,certvid_sb,certvid_v4,certvid_v5,certvid_e,faithvid,prismvid,fastvid,visionzip,fastgraphvid,curvevid.",
    )
