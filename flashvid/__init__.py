...
def flashvid(
    ...
    graph_representative_blend_alpha: float = 0.20,
    graph_spatial_spread_guard_radius: int = 0,
    graph_temporal_span_guard: int = 0,
    ...
    flashvid_config = FlashVidConfig(
        ...
        graph_representative_blend_alpha=graph_representative_blend_alpha,
        graph_spatial_spread_guard_radius=graph_spatial_spread_guard_radius,
        graph_temporal_span_guard=graph_temporal_span_guard,
