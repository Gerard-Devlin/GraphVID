...
def flashvid(
    ...
    talon_low_budget_rank_cap: int = 1,
    talon_background_global_ratio: float = 0.60,
    talon_event_budget_ratio: float = 0.45,
    ...
    talon_final_fused_weight: float = 0.55,
    talon_final_residual_weight: float = 0.30,
    talon_final_frame_weight: float = 0.15,
    talon_anchor_keep_bonus: float = 0.08,
    talon_recall_keep_bonus: float = 0.05,
