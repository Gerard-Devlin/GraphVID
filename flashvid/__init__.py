...
def flashvid(
    ...
    certv5_certificate_budget_ratio: float = 0.28,
    certv5_query_mode: str = "certificates_and_kernel",
    certv5_kernel_protect_ratio: float = 0.12,
    certv5_query_atoms: int = 8,
    certv5_temporal_bins: int = 12,
    certv5_coarse_bins: int = 4,
    certv5_spatial_bins: int = 3,
    certv5_candidate_multiplier: float = 2.5,
    certv5_query_weight: float = 0.12,
    ...
    certv5_whitening_strength: float = 0.25,
    certv5_quality_floor: float = 0.18,
    certv5_appearance_kernel_weight: float = 0.46,
    certv5_temporal_kernel_weight: float = 0.16,
    certv5_motion_kernel_weight: float = 0.16,
    certv5_event_kernel_weight: float = 0.10,
    certv5_spatial_kernel_weight: float = 0.07,
    certv5_query_kernel_weight: float = 0.05,
    certv5_appearance_temperature: float = 0.18,
    certv5_temporal_temperature: float = 0.20,
    certv5_motion_temperature: float = 0.20,
    certv5_event_temperature: float = 0.35,
    certv5_spatial_temperature: float = 0.35,
    certv5_query_temperature: float = 0.20,
    certv5_kernel_chunk_size: int = 512,
    certv5_merge_multiplier: float = 2.0,
    certv5_greedy_sample_size: int = 48,
    certv5_dual_strength: float = 0.20,
    certv5_mmd_weight: float = 0.10,
    certv5_motion_sector_threshold: float = 0.24,
    certv5_fusion_alpha: float = 0.04,
    certv5_assignment_temperature: float = 0.07,
    certv5_transport_steps: int = 4,
    certv5_transport_balance: float = 0.20,
    ...
    Args:
        ...
        compression_variant (str, optional): "flashvid" keeps original ADTS+TSTM;
            ...
            "certvid_v5" uses composable facility-location coverage and directed tracklets;
    ...
    flashvid_config = FlashVidConfig(
        ...
        certv5_kernel_protect_ratio=certv5_kernel_protect_ratio,
        ...
        certv5_appearance_kernel_weight=certv5_appearance_kernel_weight,
        certv5_temporal_kernel_weight=certv5_temporal_kernel_weight,
        certv5_motion_kernel_weight=certv5_motion_kernel_weight,
        certv5_event_kernel_weight=certv5_event_kernel_weight,
        certv5_spatial_kernel_weight=certv5_spatial_kernel_weight,
        certv5_query_kernel_weight=certv5_query_kernel_weight,
        certv5_appearance_temperature=certv5_appearance_temperature,
        certv5_temporal_temperature=certv5_temporal_temperature,
        certv5_motion_temperature=certv5_motion_temperature,
        certv5_event_temperature=certv5_event_temperature,
        certv5_spatial_temperature=certv5_spatial_temperature,
        certv5_query_temperature=certv5_query_temperature,
        certv5_kernel_chunk_size=certv5_kernel_chunk_size,
        certv5_merge_multiplier=certv5_merge_multiplier,
        certv5_greedy_sample_size=certv5_greedy_sample_size,
        certv5_dual_strength=certv5_dual_strength,
        certv5_mmd_weight=certv5_mmd_weight,
        certv5_motion_sector_threshold=certv5_motion_sector_threshold,
        certv5_fusion_alpha=certv5_fusion_alpha,
        certv5_assignment_temperature=certv5_assignment_temperature,
        certv5_transport_steps=certv5_transport_steps,
        certv5_transport_balance=certv5_transport_balance,
