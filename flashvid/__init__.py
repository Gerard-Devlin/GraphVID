...
def flashvid(
    ...
    certv5_query_mode: str = "certificates_and_spectral",
    certv5_spectral_protect_ratio: float = 0.12,
    ...
    certv5_query_weight: float = 0.18,
    ...
    certv5_appearance_weight: float = 0.46,
    certv5_temporal_weight: float = 0.16,
    certv5_motion_weight: float = 0.16,
    certv5_event_weight: float = 0.10,
    certv5_spatial_weight: float = 0.07,
    certv5_instance_weight: float = 0.10,
    certv5_query_axis_weight: float = 0.05,
    certv5_spectral_ridge: float = 0.05,
    certv5_spectral_rank_ratio: float = 0.60,
    certv5_tail_fraction: float = 0.25,
    certv5_tail_temperature: float = 0.15,
    certv5_spectral_refresh: int = 4,
    certv5_dual_strength: float = 0.20,
    certv5_mean_weight: float = 0.10,
    certv5_motion_sector_threshold: float = 0.24,
    certv5_fusion_alpha: float = 0.10,
    ...
    flashvid_config = FlashVidConfig(
        ...
        certv5_spectral_protect_ratio=certv5_spectral_protect_ratio,
        ...
        certv5_appearance_weight=certv5_appearance_weight,
        certv5_temporal_weight=certv5_temporal_weight,
        certv5_motion_weight=certv5_motion_weight,
        certv5_event_weight=certv5_event_weight,
        certv5_spatial_weight=certv5_spatial_weight,
        certv5_instance_weight=certv5_instance_weight,
        certv5_query_axis_weight=certv5_query_axis_weight,
        certv5_spectral_ridge=certv5_spectral_ridge,
        certv5_spectral_rank_ratio=certv5_spectral_rank_ratio,
        certv5_tail_fraction=certv5_tail_fraction,
        certv5_tail_temperature=certv5_tail_temperature,
        certv5_spectral_refresh=certv5_spectral_refresh,
        certv5_dual_strength=certv5_dual_strength,
        certv5_mean_weight=certv5_mean_weight,
