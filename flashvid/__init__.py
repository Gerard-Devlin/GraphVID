...
def flashvid(
    ...
    certv8_frame_floor_ratio: float = 0.35,
    certv8_frame_cap_ratio: float = 2.20,
    certv8_max_swap_ratio: float = 0.12,
    ...
    certv8_stratified_temporal_strength: float = 0.62,
    certv8_stratified_retrieval_strength: float = 0.42,
    certv8_stratified_generic_strength: float = 0.0,
    certv8_stratified_v3_keep_ratio: float = 0.62,
    certv8_stratified_max_duration_seconds: float = 1200.0,
    certv8_stratified_d_efficiency_floor: float = 0.94,
