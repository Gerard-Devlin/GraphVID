...
def flashvid(
    ...
    certv7_frame_floor_ratio: float = 0.55,
    certv7_frame_cap_ratio: float = 2.0,
    certv7_budget_temperature: float = 0.30,
    ...
    certv7_relay_ratio: float = 0.10,
    certv7_relay_query_share: float = 0.40,
    ...
    certv7_d_efficiency_floor: float = 0.90,
    ...
    Args:
        ...
        compression_variant (str, optional): "flashvid" keeps original ADTS+TSTM;
            ...
            "certvid_v7" allocates long-horizon budget with transport and local coverage;
