...
def Qwen3VLModel_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    if position_ids.shape[-1] > 1 and pixel_values_videos is not None:
        ...
        if compression_variant in {"certvid", "certvid_v2", "certvid_v3", "certvid_v6", "certvid_v7", "certvid_v8", "certvid_hr", "certvid_lh", "certvid_v4", "certvid_v5", "certvid_e", "faithvid"}:
