...
def _swap_refine(
    *,
    ...
    """Improve the selected set's log-determinant with Fedorov exchanges."""
...
def certvid_v3_compression(
    ...
    *,
    ...
    """Select the historical V3 D-optimal coreset with certificates disabled."""
    ...
    # V3Origin is the historical V3 configuration with certificate_ratio=0.
    # Preserve the selectors' empty-constraint path without constructing any
