...
def flashvid_compression(
    ...
    if compression_variant not in ("flashvid", "graphvid", "graftvid", "cats", "hedgevid", "dynflashvid", "learnflashvid"):
        raise ValueError(f"unsupported compression_variant={compression_variant!r}, expected flashvid|graphvid|graftvid|cats|hedgevid|dynflashvid|learnflashvid|talon")
