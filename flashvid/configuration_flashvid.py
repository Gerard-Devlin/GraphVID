...
class FlashVidConfig:
    ...
    certv8_frame_floor_ratio: float = field(default=0.35)
    certv8_frame_cap_ratio: float = field(default=2.20)
    certv8_max_swap_ratio: float = field(default=0.12)
