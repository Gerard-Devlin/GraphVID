...
class FlashVidConfig:
    ...
    certv8_frame_floor_ratio: float = field(default=0.30)
    certv8_frame_cap_ratio: float = field(default=2.30)
    certv8_max_swap_ratio: float = field(default=0.09)
    certv8_concentration_preserve_ratio: float = field(default=0.70)
    ...
    certv8_balance_weight: float = field(default=0.18)
