...
class FlashVidConfig:
    ...
    certv8_concentration_preserve_ratio: float = field(default=0.55)
    ...
    # CertVID V11: correspondence-lifted spatiotemporal V3 repair.
    certv11_enabled: bool = field(default=True)
    certv11_match_similarity: float = field(default=0.72)
    certv11_match_margin: float = field(default=0.015)
    certv11_cycle_radius: int = field(default=1)
    certv11_max_spatial_jump: float = field(default=0.60)
    certv11_scene_similarity: float = field(default=0.50)
    certv11_spatial_match_weight: float = field(default=0.04)
    certv11_time_confidence_seconds: float = field(default=30.0)
    certv11_transition_dim: int = field(default=32)
    certv11_state_scale: float = field(default=0.20)
    certv11_transition_weight_min: float = field(default=0.08)
    certv11_transition_weight_max: float = field(default=0.24)
    certv11_reliability_floor: float = field(default=0.015)
    certv11_reliability_target: float = field(default=0.12)
    certv11_deficit_threshold: float = field(default=0.025)
    certv11_deficit_scale: float = field(default=0.20)
    certv11_min_swap_ratio: float = field(default=0.04)
    certv11_max_swap_ratio: float = field(default=0.12)
    certv11_add_pool: int = field(default=160)
    certv11_remove_pool: int = field(default=64)
    certv11_v3_protect_ratio: float = field(default=0.10)
    certv11_node_efficiency_floor: float = field(default=0.95)
    certv11_node_loss_weight: float = field(default=0.35)
    certv11_edge_coverage_weight: float = field(default=0.30)
    certv11_frame_balance_weight: float = field(default=0.08)
    certv11_swap_margin: float = field(default=0.0)
    certv11_cross_frame_similarity: float = field(default=0.92)
    certv11_cross_frame_max_seconds: float = field(default=12.0)
    certv11_assignment_topk: int = field(default=2)
    certv11_assignment_temperature: float = field(default=0.07)
    certv11_fusion_similarity_floor: float = field(default=0.70)
