...
CERTV5_CERTIFICATE_BUDGET_RATIO="${CERTV5_CERTIFICATE_BUDGET_RATIO:-0.28}"
CERTV5_QUERY_MODE="${CERTV5_QUERY_MODE:-certificates_and_kernel}"
CERTV5_KERNEL_PROTECT_RATIO="${CERTV5_KERNEL_PROTECT_RATIO:-0.12}"
...
CERTV5_CANDIDATE_MULTIPLIER="${CERTV5_CANDIDATE_MULTIPLIER:-2.5}"
CERTV5_QUERY_WEIGHT="${CERTV5_QUERY_WEIGHT:-0.12}"
...
CERTV5_WHITENING_STRENGTH="${CERTV5_WHITENING_STRENGTH:-0.25}"
CERTV5_QUALITY_FLOOR="${CERTV5_QUALITY_FLOOR:-0.18}"
CERTV5_APPEARANCE_KERNEL_WEIGHT="${CERTV5_APPEARANCE_KERNEL_WEIGHT:-0.46}"
CERTV5_TEMPORAL_KERNEL_WEIGHT="${CERTV5_TEMPORAL_KERNEL_WEIGHT:-0.16}"
CERTV5_MOTION_KERNEL_WEIGHT="${CERTV5_MOTION_KERNEL_WEIGHT:-0.16}"
CERTV5_EVENT_KERNEL_WEIGHT="${CERTV5_EVENT_KERNEL_WEIGHT:-0.10}"
CERTV5_SPATIAL_KERNEL_WEIGHT="${CERTV5_SPATIAL_KERNEL_WEIGHT:-0.07}"
CERTV5_QUERY_KERNEL_WEIGHT="${CERTV5_QUERY_KERNEL_WEIGHT:-0.05}"
CERTV5_APPEARANCE_TEMPERATURE="${CERTV5_APPEARANCE_TEMPERATURE:-0.18}"
CERTV5_TEMPORAL_TEMPERATURE="${CERTV5_TEMPORAL_TEMPERATURE:-0.20}"
CERTV5_MOTION_TEMPERATURE="${CERTV5_MOTION_TEMPERATURE:-0.20}"
CERTV5_EVENT_TEMPERATURE="${CERTV5_EVENT_TEMPERATURE:-0.35}"
CERTV5_SPATIAL_TEMPERATURE="${CERTV5_SPATIAL_TEMPERATURE:-0.35}"
CERTV5_QUERY_TEMPERATURE="${CERTV5_QUERY_TEMPERATURE:-0.20}"
CERTV5_KERNEL_CHUNK_SIZE="${CERTV5_KERNEL_CHUNK_SIZE:-512}"
CERTV5_MERGE_MULTIPLIER="${CERTV5_MERGE_MULTIPLIER:-2.0}"
CERTV5_GREEDY_SAMPLE_SIZE="${CERTV5_GREEDY_SAMPLE_SIZE:-48}"
CERTV5_DUAL_STRENGTH="${CERTV5_DUAL_STRENGTH:-0.20}"
CERTV5_MMD_WEIGHT="${CERTV5_MMD_WEIGHT:-0.10}"
CERTV5_MOTION_SECTOR_THRESHOLD="${CERTV5_MOTION_SECTOR_THRESHOLD:-0.24}"
CERTV5_FUSION_ALPHA="${CERTV5_FUSION_ALPHA:-0.04}"
CERTV5_ASSIGNMENT_TEMPERATURE="${CERTV5_ASSIGNMENT_TEMPERATURE:-0.07}"
CERTV5_TRANSPORT_STEPS="${CERTV5_TRANSPORT_STEPS:-4}"
CERTV5_TRANSPORT_BALANCE="${CERTV5_TRANSPORT_BALANCE:-0.20}"
...
method_flash_args() {
  ...
  case "$method" in
    ...
    certvid_v4)
      ...
      ;;
    certvid_v5)
      printf 'compression_variant=certvid_v5,token_selection_method=%s,certv5_budget_mode=%s,certv5_attention_policy=%s,certv5_attention_eps=%s,certv5_certificate_budget_ratio=%s,certv5_query_mode=%s,certv5_kernel_protect_ratio=%s,certv5_query_atoms=%s,certv5_temporal_bins=%s,certv5_coarse_bins=%s,certv5_spatial_bins=%s,certv5_candidate_multiplier=%s,certv5_query_weight=%s,certv5_track_threshold=%s,certv5_spatial_penalty=%s,certv5_metric_dim=%s,certv5_frame_coverage_ratio=%s,certv5_query_threshold=%s,certv5_query_per_atom=%s,certv5_whitening_strength=%s,certv5_quality_floor=%s,certv5_appearance_kernel_weight=%s,certv5_temporal_kernel_weight=%s,certv5_motion_kernel_weight=%s,certv5_event_kernel_weight=%s,certv5_spatial_kernel_weight=%s,certv5_query_kernel_weight=%s,certv5_appearance_temperature=%s,certv5_temporal_temperature=%s,certv5_motion_temperature=%s,certv5_event_temperature=%s,certv5_spatial_temperature=%s,certv5_query_temperature=%s,certv5_kernel_chunk_size=%s,certv5_merge_multiplier=%s,certv5_greedy_sample_size=%s,certv5_dual_strength=%s,certv5_mmd_weight=%s,certv5_motion_sector_threshold=%s,certv5_fusion_alpha=%s,certv5_assignment_temperature=%s,certv5_transport_steps=%s,certv5_transport_balance=%s,certv5_max_scenes=%s,certv5_scene_threshold=%s,certv5_min_scene_frames=%s,certv5_motion_threshold=%s,certv5_motion_confidence_threshold=%s,certv5_motion_fusion_threshold=%s,certv5_router_strength=%s,certv5_debug=%s' \
        "$CERTV5_TOKEN_SELECTION_METHOD" "$CERTV5_BUDGET_MODE" "$CERTV5_ATTENTION_POLICY" "$CERTV5_ATTENTION_EPS" "$CERTV5_CERTIFICATE_BUDGET_RATIO" "$CERTV5_QUERY_MODE" "$CERTV5_KERNEL_PROTECT_RATIO" "$CERTV5_QUERY_ATOMS" "$CERTV5_TEMPORAL_BINS" "$CERTV5_COARSE_BINS" "$CERTV5_SPATIAL_BINS" "$CERTV5_CANDIDATE_MULTIPLIER" "$CERTV5_QUERY_WEIGHT" "$CERTV5_TRACK_THRESHOLD" "$CERTV5_SPATIAL_PENALTY" "$CERTV5_METRIC_DIM" "$CERTV5_FRAME_COVERAGE_RATIO" "$CERTV5_QUERY_THRESHOLD" "$CERTV5_QUERY_PER_ATOM" "$CERTV5_WHITENING_STRENGTH" "$CERTV5_QUALITY_FLOOR" "$CERTV5_APPEARANCE_KERNEL_WEIGHT" "$CERTV5_TEMPORAL_KERNEL_WEIGHT" "$CERTV5_MOTION_KERNEL_WEIGHT" "$CERTV5_EVENT_KERNEL_WEIGHT" "$CERTV5_SPATIAL_KERNEL_WEIGHT" "$CERTV5_QUERY_KERNEL_WEIGHT" "$CERTV5_APPEARANCE_TEMPERATURE" "$CERTV5_TEMPORAL_TEMPERATURE" "$CERTV5_MOTION_TEMPERATURE" "$CERTV5_EVENT_TEMPERATURE" "$CERTV5_SPATIAL_TEMPERATURE" "$CERTV5_QUERY_TEMPERATURE" "$CERTV5_KERNEL_CHUNK_SIZE" "$CERTV5_MERGE_MULTIPLIER" "$CERTV5_GREEDY_SAMPLE_SIZE" "$CERTV5_DUAL_STRENGTH" "$CERTV5_MMD_WEIGHT" "$CERTV5_MOTION_SECTOR_THRESHOLD" "$CERTV5_FUSION_ALPHA" "$CERTV5_ASSIGNMENT_TEMPERATURE" "$CERTV5_TRANSPORT_STEPS" "$CERTV5_TRANSPORT_BALANCE" "$CERTV5_MAX_SCENES" "$CERTV5_SCENE_THRESHOLD" "$CERTV5_MIN_SCENE_FRAMES" "$CERTV5_MOTION_THRESHOLD" "$CERTV5_MOTION_CONFIDENCE_THRESHOLD" "$CERTV5_MOTION_FUSION_THRESHOLD" "$CERTV5_ROUTER_STRENGTH" "$CERTV5_DEBUG"
      ;;
    visionzip)
