...
CERTV8_STRATIFIED_TEMPORAL_STRENGTH="${CERTV8_STRATIFIED_TEMPORAL_STRENGTH:-0.62}"
CERTV8_STRATIFIED_RETRIEVAL_STRENGTH="${CERTV8_STRATIFIED_RETRIEVAL_STRENGTH:-0.42}"
CERTV8_STRATIFIED_GENERIC_STRENGTH="${CERTV8_STRATIFIED_GENERIC_STRENGTH:-0.0}"
CERTV8_STRATIFIED_V3_KEEP_RATIO="${CERTV8_STRATIFIED_V3_KEEP_RATIO:-0.62}"
CERTV8_STRATIFIED_MAX_DURATION_SECONDS="${CERTV8_STRATIFIED_MAX_DURATION_SECONDS:-1200.0}"
CERTV8_STRATIFIED_D_EFFICIENCY_FLOOR="${CERTV8_STRATIFIED_D_EFFICIENCY_FLOOR:-0.94}"
...
method_args() {
  ...
  case "$method" in
    ...
    certvid_v8)
      ...
      printf ',certv8_enabled=%s,certv8_intent_router=%s,certv8_intent_strength=%s,certv8_min_horizon_gap_seconds=%s,certv8_min_deficit=%s,certv8_frame_floor_ratio=%s,certv8_frame_cap_ratio=%s,certv8_max_swap_ratio=%s,certv8_concentration_preserve_ratio=%s,certv8_query_peak_count=%s,certv8_query_peak_separation=%s,certv8_query_weight=%s,certv8_event_weight=%s,certv8_balance_weight=%s,certv8_design_protect_ratio=%s,certv8_query_protect_ratio=%s,certv8_d_efficiency_floor=%s,certv8_min_objective_gain=%s,certv8_cross_frame_similarity=%s,certv8_cross_frame_max_seconds=%s,certv8_stratified_enabled=%s,certv8_stratified_temporal_strength=%s,certv8_stratified_retrieval_strength=%s,certv8_stratified_generic_strength=%s,certv8_stratified_v3_keep_ratio=%s,certv8_stratified_max_duration_seconds=%s,certv8_stratified_d_efficiency_floor=%s,certv8_stratified_query_tolerance=%s,certv8_debug=%s' \
        "$CERTV8_ENABLED" "$CERTV8_INTENT_ROUTER" "$CERTV8_INTENT_STRENGTH" "$CERTV8_MIN_HORIZON_GAP_SECONDS" "$CERTV8_MIN_DEFICIT" "$CERTV8_FRAME_FLOOR_RATIO" "$CERTV8_FRAME_CAP_RATIO" "$CERTV8_MAX_SWAP_RATIO" "$CERTV8_CONCENTRATION_PRESERVE_RATIO" "$CERTV8_QUERY_PEAK_COUNT" "$CERTV8_QUERY_PEAK_SEPARATION" "$CERTV8_QUERY_WEIGHT" "$CERTV8_EVENT_WEIGHT" "$CERTV8_BALANCE_WEIGHT" "$CERTV8_DESIGN_PROTECT_RATIO" "$CERTV8_QUERY_PROTECT_RATIO" "$CERTV8_D_EFFICIENCY_FLOOR" "$CERTV8_MIN_OBJECTIVE_GAIN" "$CERTV8_CROSS_FRAME_SIMILARITY" "$CERTV8_CROSS_FRAME_MAX_SECONDS" "$CERTV8_STRATIFIED_ENABLED" "$CERTV8_STRATIFIED_TEMPORAL_STRENGTH" "$CERTV8_STRATIFIED_RETRIEVAL_STRENGTH" "$CERTV8_STRATIFIED_GENERIC_STRENGTH" "$CERTV8_STRATIFIED_V3_KEEP_RATIO" "$CERTV8_STRATIFIED_MAX_DURATION_SECONDS" "$CERTV8_STRATIFIED_D_EFFICIENCY_FLOOR" "$CERTV8_STRATIFIED_QUERY_TOLERANCE" "$CERTV8_DEBUG"
      ;;
    certvid_hr)
