...
CERTV8_GATE_THRESHOLD="${CERTV8_GATE_THRESHOLD:-0.18}"
CERTV8_MIN_RELATION_DEFICIT="${CERTV8_MIN_RELATION_DEFICIT:-0.04}"
CERTV8_SHORT_MAX_SWAP_RATIO="${CERTV8_SHORT_MAX_SWAP_RATIO:-0.12}"
CERTV8_LONG_MAX_SWAP_RATIO="${CERTV8_LONG_MAX_SWAP_RATIO:-0.06}"
CERTV8_LONG_DURATION_SECONDS="${CERTV8_LONG_DURATION_SECONDS:-120.0}"
CERTV8_RELATION_LAGS="${CERTV8_RELATION_LAGS:-1:2:4}"
CERTV8_PAIRS_PER_BOUNDARY="${CERTV8_PAIRS_PER_BOUNDARY:-4}"
CERTV8_MATCH_SPATIAL_PENALTY="${CERTV8_MATCH_SPATIAL_PENALTY:-0.08}"
CERTV8_MATCH_MIN_SIMILARITY="${CERTV8_MATCH_MIN_SIMILARITY:-0.25}"
CERTV8_RELATION_COVERAGE_THRESHOLD="${CERTV8_RELATION_COVERAGE_THRESHOLD:-0.88}"
CERTV8_MIN_RELATION_GAIN="${CERTV8_MIN_RELATION_GAIN:-0.002}"
CERTV8_D_EFFICIENCY_FLOOR="${CERTV8_D_EFFICIENCY_FLOOR:-0.98}"
CERTV8_LONG_D_EFFICIENCY_FLOOR="${CERTV8_LONG_D_EFFICIENCY_FLOOR:-0.98}"
CERTV8_FRAME_SHAPE_GATE="${CERTV8_FRAME_SHAPE_GATE:-0.08}"
CERTV8_FRAME_FLOOR_RATIO="${CERTV8_FRAME_FLOOR_RATIO:-0.88}"
CERTV8_FRAME_CAP_RATIO="${CERTV8_FRAME_CAP_RATIO:-1.18}"
CERTV8_DESIGN_PROTECT_RATIO="${CERTV8_DESIGN_PROTECT_RATIO:-0.10}"
CERTV8_RELATION_PROTECT_RATIO="${CERTV8_RELATION_PROTECT_RATIO:-0.05}"
CERTV8_QUERY_WEIGHT="${CERTV8_QUERY_WEIGHT:-0.15}"
CERTV8_ASSIGNMENT_TOPK="${CERTV8_ASSIGNMENT_TOPK:-2}"
CERTV8_ASSIGNMENT_TEMPERATURE="${CERTV8_ASSIGNMENT_TEMPERATURE:-0.07}"
...
CERTV8_COMPONENT_BONUS="${CERTV8_COMPONENT_BONUS:-0.08}"
CERTV8_FUSION_ALPHA="${CERTV8_FUSION_ALPHA:-0.10}"
CERTV8_DEBUG="${CERTV8_DEBUG:-False}"
...
method_args() {
  ...
  case "$method" in
    ...
    certvid_v8)
      ...
      printf ',certv8_enabled=%s,certv8_gate_threshold=%s,certv8_min_relation_deficit=%s,certv8_short_max_swap_ratio=%s,certv8_long_max_swap_ratio=%s,certv8_long_duration_seconds=%s,certv8_relation_lags=%s,certv8_pairs_per_boundary=%s,certv8_match_spatial_penalty=%s,certv8_match_min_similarity=%s,certv8_relation_coverage_threshold=%s,certv8_min_relation_gain=%s,certv8_d_efficiency_floor=%s,certv8_long_d_efficiency_floor=%s,certv8_frame_shape_gate=%s,certv8_frame_floor_ratio=%s,certv8_frame_cap_ratio=%s,certv8_design_protect_ratio=%s,certv8_relation_protect_ratio=%s,certv8_query_weight=%s,certv8_assignment_topk=%s,certv8_assignment_temperature=%s,certv8_cross_frame_similarity=%s,certv8_cross_frame_max_seconds=%s,certv8_component_bonus=%s,certv8_fusion_alpha=%s,certv8_debug=%s' \
        "$CERTV8_ENABLED" "$CERTV8_GATE_THRESHOLD" "$CERTV8_MIN_RELATION_DEFICIT" "$CERTV8_SHORT_MAX_SWAP_RATIO" "$CERTV8_LONG_MAX_SWAP_RATIO" "$CERTV8_LONG_DURATION_SECONDS" "$CERTV8_RELATION_LAGS" "$CERTV8_PAIRS_PER_BOUNDARY" "$CERTV8_MATCH_SPATIAL_PENALTY" "$CERTV8_MATCH_MIN_SIMILARITY" "$CERTV8_RELATION_COVERAGE_THRESHOLD" "$CERTV8_MIN_RELATION_GAIN" "$CERTV8_D_EFFICIENCY_FLOOR" "$CERTV8_LONG_D_EFFICIENCY_FLOOR" "$CERTV8_FRAME_SHAPE_GATE" "$CERTV8_FRAME_FLOOR_RATIO" "$CERTV8_FRAME_CAP_RATIO" "$CERTV8_DESIGN_PROTECT_RATIO" "$CERTV8_RELATION_PROTECT_RATIO" "$CERTV8_QUERY_WEIGHT" "$CERTV8_ASSIGNMENT_TOPK" "$CERTV8_ASSIGNMENT_TEMPERATURE" "$CERTV8_CROSS_FRAME_SIMILARITY" "$CERTV8_CROSS_FRAME_MAX_SECONDS" "$CERTV8_COMPONENT_BONUS" "$CERTV8_FUSION_ALPHA" "$CERTV8_DEBUG"
      ;;
    certvid_hr)
