...
CERTV7_FRAME_FLOOR_RATIO="${CERTV7_FRAME_FLOOR_RATIO:-0.55}"
CERTV7_FRAME_CAP_RATIO="${CERTV7_FRAME_CAP_RATIO:-2.0}"
CERTV7_BUDGET_TEMPERATURE="${CERTV7_BUDGET_TEMPERATURE:-0.30}"
...
CERTV7_RELAY_RATIO="${CERTV7_RELAY_RATIO:-0.10}"
CERTV7_RELAY_QUERY_SHARE="${CERTV7_RELAY_QUERY_SHARE:-0.40}"
...
CERTV7_D_EFFICIENCY_FLOOR="${CERTV7_D_EFFICIENCY_FLOOR:-0.90}"
