...
CERTV8_LOCAL_MIX="${CERTV8_LOCAL_MIX:-0.55}"
CERTV8_LOCAL_UNIFORMITY="${CERTV8_LOCAL_UNIFORMITY:-0.80}"
CERTV8_LOCAL_DIVERSITY_WEIGHT="${CERTV8_LOCAL_DIVERSITY_WEIGHT:-0.28}"
CERTV8_MIN_HORIZON_GAP_SECONDS="${CERTV8_MIN_HORIZON_GAP_SECONDS:-4.0}"
CERTV8_MIN_DISAGREEMENT_RATIO="${CERTV8_MIN_DISAGREEMENT_RATIO:-0.08}"
CERTV8_COMPLEMENTARITY_WEIGHT="${CERTV8_COMPLEMENTARITY_WEIGHT:-0.30}"
CERTV8_LOCAL_QUALITY_WEIGHT="${CERTV8_LOCAL_QUALITY_WEIGHT:-0.35}"
CERTV8_V3_COVERAGE_WEIGHT="${CERTV8_V3_COVERAGE_WEIGHT:-0.58}"
CERTV8_MIN_JOINT_GAIN="${CERTV8_MIN_JOINT_GAIN:-0.001}"
CERTV8_SWAP_MARGIN="${CERTV8_SWAP_MARGIN:--0.02}"
CERTV8_STRUCTURAL_ATTENTION_WEIGHT="${CERTV8_STRUCTURAL_ATTENTION_WEIGHT:-0.25}"
CERTV8_STRUCTURAL_NOVELTY_WEIGHT="${CERTV8_STRUCTURAL_NOVELTY_WEIGHT:-0.35}"
CERTV8_STRUCTURAL_DETAIL_WEIGHT="${CERTV8_STRUCTURAL_DETAIL_WEIGHT:-0.25}"
...
CERTV8_LONG_MAX_SWAP_RATIO="${CERTV8_LONG_MAX_SWAP_RATIO:-0.20}"
...
CERTV8_LONG_D_EFFICIENCY_FLOOR="${CERTV8_LONG_D_EFFICIENCY_FLOOR:-0.95}"
...
method_args() {
  ...
  case "$method" in
    ...
    certvid_v8)
      ...
      printf ',certv8_local_mix=%s,certv8_local_uniformity=%s,certv8_local_diversity_weight=%s,certv8_min_horizon_gap_seconds=%s,certv8_min_disagreement_ratio=%s,certv8_complementarity_weight=%s,certv8_local_quality_weight=%s,certv8_v3_coverage_weight=%s,certv8_min_joint_gain=%s,certv8_swap_margin=%s,certv8_structural_attention_weight=%s,certv8_structural_novelty_weight=%s,certv8_structural_detail_weight=%s' \
        "$CERTV8_LOCAL_MIX" "$CERTV8_LOCAL_UNIFORMITY" "$CERTV8_LOCAL_DIVERSITY_WEIGHT" "$CERTV8_MIN_HORIZON_GAP_SECONDS" "$CERTV8_MIN_DISAGREEMENT_RATIO" "$CERTV8_COMPLEMENTARITY_WEIGHT" "$CERTV8_LOCAL_QUALITY_WEIGHT" "$CERTV8_V3_COVERAGE_WEIGHT" "$CERTV8_MIN_JOINT_GAIN" "$CERTV8_SWAP_MARGIN" "$CERTV8_STRUCTURAL_ATTENTION_WEIGHT" "$CERTV8_STRUCTURAL_NOVELTY_WEIGHT" "$CERTV8_STRUCTURAL_DETAIL_WEIGHT"
